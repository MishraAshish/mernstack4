...
//products
export const FETCH_NPRODUCTS = "PRODUCT.FETCH_NPRODUCTS";
export const FETCH_NPRODUCTS_FULFILLED = "PRODUCT.FETCH_NPRODUCTS_FULFILLED";
export const FETCH_NPRODUCTS_REJECTED = "PRODUCT.FETCH_NPRODUCTS_REJECTED";
